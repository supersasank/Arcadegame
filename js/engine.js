            ...
            case "startGame":
                ...
                for (row = 0; row < numRows; row++) {
                    for (col = 0; col < numCols; col++) {
                        ...
                        ctx.textAlign = "center";
                        ctx.fillText("Press Enter To Begin", canvas.width / 2, canvas.height / 4);
                        ctx.fillStyle = "red";
                        ctx.font = "20px Comic Sans MS";
                        ctx.textAlign = "center";
                        ctx.fillText("Use the arrow keys to move", canvas.width / 2, canvas.height / 3.3);
                        ctx.fillText("Reach the water and collect gems to increase score", canvas.width / 2, canvas.height / 3.0);
                        ...
                        ctx.font = "20px Comic Sans MS";
                        ctx.textAlign = "center";
                        ctx.strokeText("Use the arrow keys to move", canvas.width / 2, canvas.height / 3.3);
                        ctx.strokeText("Difficulty increases when you reach water", canvas.width / 2, canvas.height / 2.75);
                        ctx.strokeText("Reach the water and collect gems to increase score", canvas.width / 2, canvas.height / 3.0);
                        ctx.strokeText("Collect hearts for extra lives", canvas.width / 2, canvas.height / 2.55);
                        ctx.strokeText("Avoid the bugs to stay alive", canvas.width / 2, canvas.height / 2.37);
                        ctx.fillStyle = "blue";
                        ctx.font = "30px comic Sans MS";
                        ctx.textAlign = "center";
                        ctx.fillText("Have Fun!", canvas.width / 2, canvas.height / 2.1);
                    }
                }
                break;
            case "inGame":
            ...
            case "gameOver":
                ...
                for (row = 0; row < numRows; row++) {
                    for (col = 0; col < numCols; col++) {
                        ...
                        ctx.font = "20px Comic Sans MS";
                        ctx.textAlign = "center";
                        ctx.fillText("Enter To Restart", canvas.width / 2, canvas.height / 2.6);
                    }
                }
                break;
        }
